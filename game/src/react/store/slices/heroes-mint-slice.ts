...
export const loadMintDetails = createAsyncThunk("app/init",
...
const heroesMintSlice = createSlice({
    ...
    extraReducers: builder => {
        builder
            .addCase(loadMintDetails.pending, state => {
                state.loading = true
            })
            .addCase(loadMintDetails.fulfilled, (state, action) => {
                setAll(state, action.payload)
                state.loading = false
            })
            .addCase(loadMintDetails.rejected, (state, {error}) => {
                state.loading = false
                console.log(error)
            })
    }
